  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 glass">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <Link to="/" className="bg-white/[0.06] backdrop-blur-xl border border-white/[0.12] px-3 py-1.5 rounded-xl hover:bg-white/[0.1] transition-colors">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <div className="relative" ref={langRef}>
            ...
            {langOpen && (
              <div className="absolute right-0 top-full mt-1 glass p-1 rounded-xl min-w-[80px]">
                <button
                  onClick={() => switchLang('en')}
                  className={`w-full text-left px-3 py-1.5 text-sm rounded-lg focus-ring ${lang === 'en' ? 'text-primary bg-primary/10' : 'text-text-muted hover:text-text'}`}
                >
                  EN
                </button>
                <button
                  onClick={() => switchLang('fr')}
                  className={`w-full text-left px-3 py-1.5 text-sm rounded-lg focus-ring ${lang === 'fr' ? 'text-primary bg-primary/10' : 'text-text-muted hover:text-text'}`}
                >
                  FR
                </button>
              </div>
        ...
        <button
          ...
          className="md:hidden text-text-muted hover:text-text transition-colors p-2 focus-ring"
          ...
          >
            <div className="px-4 py-4 flex flex-col gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={() => switchLang('en')}
                  className={`text-sm focus-ring px-2 py-1 rounded ${lang === 'en' ? 'text-primary bg-primary/10' : 'text-text-muted hover:text-text'}`}
                >
                  EN
                </button>
                <button
                  onClick={() => switchLang('fr')}
                  className={`text-sm focus-ring px-2 py-1 rounded ${lang === 'fr' ? 'text-primary bg-primary/10' : 'text-text-muted hover:text-text'}`}
                >
                  FR
                </button>
              </div>
