  ...
  return (
    <footer className="bg-surface mt-20 py-12 px-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          <h4 className="font-semibold mb-4" style={{ fontFamily: 'Poppins' }}>{t('footer.quickLinks')}</h4>
        ...
        <div>
          <h4 className="font-semibold mb-4" style={{ fontFamily: 'Poppins' }}>{t('footer.contact')}</h4>
          <div className="flex flex-col gap-2 text-sm">
      ...
      <div className="max-w-7xl mx-auto mt-8 pt-8 border-t border-white/10 text-center text-text-muted text-xs">
